#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ด่านก่อนคิดเป็นลายลักษณ์อักษร — hook PreToolUse สำหรับ Write และ Edit (V01R01 · 2026.09.05)
...
def main():
    ...
    return deny("ยังเขียนไฟล์กำหนดเนื้อหาไม่ได้ เพราะขั้น \"โหลดก่อนคิด\" ยังไม่ครบ — " + " · ".join(parts) + " — เหตุผล: งานสิงหาคม–กันยายน 2026 ที่คิดก่อนโหลด skill ต้องกลับมาแก้ภาษา สี และเลย์เอาต์ซ้ำหลายสิบรอบ")
