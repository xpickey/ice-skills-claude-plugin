...
- **Build เป็นไฟล์จริง → route ผ่าน เจนนี่ (deliverable-gen-agent)** — ผู้ทรงไม่ build/ไม่ generate ภาพเอง (เหมือน .docx/.pptx · PRE-BUILD STOP). เจนนี่ถือ nanobanana + higgsfield MCP และรู้ Execution Path Rule (Claude Code→CLI · Desktop/Web→MCP · nanobanana=MCP เสมอ · preflight cost ก่อนงานแพง).
