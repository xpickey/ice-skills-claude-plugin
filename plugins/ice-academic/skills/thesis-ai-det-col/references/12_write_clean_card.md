...
- **B7 No-Theatrical Wording (ห้ามคำละคร/เกม — เคส Viriyah VFIN 2026.07):**
  ...
  - 🟢 ใช้ได้ (อย่าตัดผิด): "day-in-the-life" scenario naming (เช่น "หนึ่งวันของฝ่ายบัญชี") = business demo framing มาตรฐาน
  - ใช้กับทั้งไฟล์ .md ภายในที่จะกลายเป็น deck และ deliverable ลูกค้าทุกชนิด — คู่กับ W3 Anti-ลิเก (`11` §6)
