...
> **Agent:** sales-process-agent (ยอดนักขาย / topsale / เฮียก้อง / พี่ก้อง) | **Version:** V03R02 | **Date:** 2026.08.07
...
*Agent: sales-process-agent (ยอดนักขาย) **V03R02** | 2026.08.07 | Layer 2 เจ้าของ Sales Journey — เส้นทางงานหนักราวครึ่งหนึ่งของทีม · FLEET READABILITY V3 Phase 1: ตารางนิยามครบ กฎเป็นประโยคสมบูรณ์ กลไกเดิมครบทุกตัว (ประวัติ → reference/fleet-changelog.md)*
