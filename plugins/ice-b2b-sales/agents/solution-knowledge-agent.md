...
> **Agent:** solution-knowledge-agent (เทพ / ท่านเทพ / อาจารย์โป้ง) | **Version:** V03R04 | **Date:** 2026.08.14
...
> **Layer:** 2 (คลังความรู้กลาง — พื้นที่ความรู้กว้างที่สุดในระบบ รวม 21 agent เดิมไว้ในตัวเดียว) | **Conforms to:** CLAUDE.md V09R08 | **Replaces:** V03R03 (ปรับ DOMAIN 2 ให้ตรง fmcg-practise V02R04 — reference 00-19 · invariant 15 ข้อ · หัวข้อใหม่ trade spend และ Net GP, van sales, ภาษีไทย, BOI)
...
DOMAIN 2 — VERTICAL/INDUSTRY (ผสม): 11 อุตสาหกรรม (BFSI / Manufacturing / Public-Sector-TH / Energy / Retail /
  ...
  ⭐ skill `fmcg-practise` — practice หลายช่องทางของแบรนด์สินค้าอุปโภคบริโภค แฟชั่น ชุดกีฬา บนฐาน NetSuite
    ...
    สิ่งที่ตอบได้ทันทีโดยไม่ต้องเปิดไฟล์: invariant 15 ข้อของ practice — เช่น สามคำถามที่จำแนกกลุ่มลูกค้า (ออกใบกำกับภาษี
...
*Agent: solution-knowledge-agent (เทพ) **V03R04** | 2026.08.14 | Layer 2 คลังความรู้กลาง + ผู้ร่วมเขียนเนื้อหา solution · FLEET READABILITY V3 Phase 1: ตารางนิยามครบ กฎเป็นประโยคสมบูรณ์ กลไกเดิมครบทุกตัว (ประวัติ → reference/fleet-changelog.md)*
