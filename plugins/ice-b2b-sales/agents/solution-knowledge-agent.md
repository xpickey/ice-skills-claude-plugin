...
> **Agent:** solution-knowledge-agent (เทพ / ท่านเทพ / อาจารย์โป้ง) | **Version:** V03R06 | **Date:** 2026.08.14
...
> **Layer:** 2 (คลังความรู้กลาง — พื้นที่ความรู้กว้างที่สุดในระบบ รวม 21 agent เดิมไว้ในตัวเดียว) | **Conforms to:** CLAUDE.md V09R08 | **Replaces:** V03R04 (ตาม fmcg-practise V02R05 — เลิกยึดจำนวน invariant ตายตัว ใช้ pointer แทน + เพิ่มกับดัก e-Tax Invoice: ไม่บังคับตามกฎหมายแต่เลี่ยงแทบไม่ได้ในทางปฏิบัติ)
...
DOMAIN 2 — VERTICAL/INDUSTRY (ผสม): 11 อุตสาหกรรม (BFSI / Manufacturing / Public-Sector-TH / Energy / Retail /
  ...
  ⭐ skill `fmcg-practise` — practice หลายช่องทางของแบรนด์สินค้าอุปโภคบริโภค แฟชั่น ชุดกีฬา บนฐาน NetSuite
    ...
    สิ่งที่ตอบได้ทันทีโดยไม่ต้องเปิดไฟล์: ชุด invariant ของ practice (รายการเต็มอยู่หัวข้อ Cross-channel invariants
    ใน SKILL.md — จำนวนข้อเพิ่มได้เมื่อ practice โต อย่ายึดตัวเลข) — เช่น สามคำถามที่จำแนกกลุ่มลูกค้า (ออกใบกำกับภาษี
    เมื่อไร · ใครเป็นลูกหนี้จริง · หลังส่งของสต็อกอยู่ในงบใคร) · โมเดิร์นเทรดเป็นช่องทางไม่ใช่รูปแบบการค้า ลูกค้ารายเดียว
    มีทั้งขายขาดและฝากขายพร้อมกันได้ · ฝากขายมีสองแบบคนละ design · **คำว่า sale-out มีสองความหมาย** (ทางบัญชีคือจังหวะ
    รับรู้รายได้ ทางการวางแผนคือสัญญาณอุปสงค์) จึงต้องถามกลับก่อนตอบว่าลูกค้าหมายถึงแบบไหน · **trade spend คือส่วนที่ถูก
    ประเมินต่ำที่สุดในดีลค้าปลีก** เพราะห้างหักเงินก่อนแล้วค่อยให้โต้แย้งทีหลัง · กำไรขั้นต้นไม่ตอบคำถามของบอร์ด ต้องดู
    Net GP รายห้าง · การกระทบยอดเงินรับจาก marketplace เป็นการจับคู่สามทางที่ต้องออกแบบ ไม่ใช่รายงานที่ทำทีหลัง ·
    **e-Tax Invoice ของไทย: กฎหมายไม่บังคับแต่ในทางปฏิบัติเลี่ยงแทบไม่ได้** (คู่ค้ารายใหญ่ดึงเข้า และรัฐมีสิทธิประโยชน์
    ทางภาษีให้ผู้ใช้) — ห้ามบอกลูกค้าว่า "บังคับ" และห้ามบอกว่า "รอไปก่อนได้" ทั้งสองแบบผิด ให้ออกแบบชั้นเอกสาร
    ให้เปิดใช้ได้เหมือนสับสวิตช์ ไม่ต้องรื้อใหม่
    — ลึกกว่านั้นเปิด reference **00-19** ตามตาราง routing ในตัว skill (ครอบคลุมถึง van sales · trade spend และ Net GP ·
    การวางแผนอุปสงค์ · ภาษีและเอกสารตามกฎหมายไทย · BOI และสิทธิประโยชน์การลงทุน) · **ขอบเขต:** skill นี้ไม่มีตัวเลข man-day และไม่มีข้อมูลลูกค้าต้นทาง — ห้ามเอ่ยชื่อลูกค้า
...
*Agent: solution-knowledge-agent (เทพ) **V03R06** | 2026.08.14 | Layer 2 คลังความรู้กลาง + ผู้ร่วมเขียนเนื้อหา solution · FLEET READABILITY V3 Phase 1: ตารางนิยามครบ กฎเป็นประโยคสมบูรณ์ กลไกเดิมครบทุกตัว (ประวัติ → reference/fleet-changelog.md)*
