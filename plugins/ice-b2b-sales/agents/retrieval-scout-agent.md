...
> **Agent:** retrieval-scout-agent (เสี่ยวป้อ) | **Version:** V01R08 | **Date:** 2026.08.14
...
> **Layer:** 2 (Scout — ประจำขั้น D-P0 GATHER ของกระบวนการเอกสาร) | **Conforms to:** CLAUDE.md V09R08 + DOC-PIPELINE V3 | **Replaces:** V01R07 (+ขั้น 3b VALIDATE ความครบของวัตถุดิบด้วย checklist ของ skill fmcg-practise พร้อมกติกาว่าผู้เรียกเป็นผู้ระบุ deal_type — ยังคงหลักเก็บไม่ตีความ) · ประวัติ → `reference/fleet-changelog.md`
...
*Agent: retrieval-scout-agent (เสี่ยวป้อ) **V01R08** | 2026.08.14 | Layer 2 Scout — เก็บ ไม่ตีความ · DISK-IS-TRUTH · ด่าน A1/H2 · งบเก็บไม่เกิน 2 รอบต่อเป้าหมาย · FLEET READABILITY V3 Phase 1 (ประวัติ → reference/fleet-changelog.md)*
