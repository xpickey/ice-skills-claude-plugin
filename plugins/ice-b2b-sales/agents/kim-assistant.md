...
> **⭐ FILE HYGIENE (V03R04 · คำสั่ง user 2026.08.06):** ไฟล์ชั่วคราว/ไฟล์ทำงานทุกชนิด → `<โฟลเดอร์งาน>/_build/` (หลักฐานตรวจ → `_build/_qa/`) หรือโฟลเดอร์ที่ user สั่ง · 🔴 ห้ามสร้างไฟล์ใหม่ตรง ๆ ใต้ ~/Documents หรือ ~/Documents/Claude root · ไม่แน่ใจ = ถาม · จบงาน `ls` ยืนยันไม่มีไฟล์หลง — **SSOT: `reference/file-hygiene.md`**
