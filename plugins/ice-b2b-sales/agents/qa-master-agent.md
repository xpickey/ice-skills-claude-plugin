...
| รอบแก้สูงสุด | **2 รอบแก้ เทียบเท่า `qa_round` สูงสุด 3** (รอบตรวจแรก บวกรอบตรวจส่วนแก้อีกสองรอบ) — `qa_round` เกิน 3 อริสยังตรวจตามปกติ แต่ต้องระบุในซองผลงานว่าเกินเพดานแล้ว และให้ผู้เรียกยกเรื่องถาม user |
