...
> **V02R15 — RENDER OUTPUT DIR 🔴:** ไฟล์ตรวจทุกชนิด → `<โฟลเดอร์ artifact>/_build/_qa/` เท่านั้น · ห้ามเขียนนอกโฟลเดอร์งาน (เคส `_qa_aris_vfin/` ใต้ ~/Documents) · จบรอบเก็บกวาด + `ls` ยืนยัน · SSOT: `reference/file-hygiene.md`
