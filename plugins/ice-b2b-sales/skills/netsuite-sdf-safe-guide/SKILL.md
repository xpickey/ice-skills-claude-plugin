...
description: "ใช้เมื่อพัฒนาหรือตรวจงาน NetSuite SDF ตามคู่มือ SAFE Guide ของ Oracle — สร้างไฟล์ XML สำหรับ script ทั้ง 14 ประเภท คุมเพดานหน่วยประมวลผล ปรับสมรรถนะด้วย N/cache และ N/query ออกแบบความปลอดภัยและ OAuth 2.0 พร้อมข้อผิดพลาดที่พบบ่อยกว่า 140 รายการ · เป็น skill ที่ใหญ่ที่สุดในชุดนี้ เรียกเมื่อลงมือทำงาน SDF จริงเท่านั้น · คำกระตุ้น: SDF best practice, สร้าง object XML, governance limit, N/cache, N/query, SuiteApp development, deploy.xml"
