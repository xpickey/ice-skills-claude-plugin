...
### 2.2b พื้นหลังลายเส้นทอง — ⭐ บังคับทุก deck (คำสั่ง user 2026.09.06 · ปฏิบัติอย่างเคร่งครัด)

พื้นไล่เฉดในหัวข้อ 2.2 เป็น **พื้นชั้นล่างสุด ไม่ใช่พื้นหลังสุดท้ายของงาน** ทุก deck ต้องมีภาพพื้นหลังลายเส้นทองคล้ำวางทับพื้นไล่เฉดนั้นอีกชั้น โดยมีเงื่อนไขสามข้อ:

- **สร้างใหม่ทุกครั้งตามหัวเรื่องของเอกสารชิ้นนั้น** — ห้ามใช้ไฟล์พื้นหลังของงานก่อนหน้าที่คนละหัวเรื่อง และห้ามมีไฟล์พื้นหลังกลางที่ตายตัว
- **ลายเส้นทองคล้ำ เส้นบาง โปร่ง** กระจุกที่ขอบขวาและขอบล่าง เว้นฝั่งซ้ายให้โล่งสำหรับหัวเรื่องและเนื้อความ — ต้องไม่บังสายตาและไม่ทับข้อความ
- **ห้ามทองสดหรือทองมัน** (อ่านแล้วเป็นการ์ดอวยพร ไม่ใช่เอกสารที่ปรึกษา)

**สูตรการผลิตอยู่ที่เดียว** คือ `ice-doc-builder/references/ice-super-template.md` §4 (ลายตามหัวเรื่องและอุตสาหกรรม · โมเดลและคำสั่งภาพ · จำนวนภาพต่อเล่ม · ช่อง `background_dark`/`background_light` ที่ต่อเข้ากับตัวสร้างไฟล์ · การตรวจก่อนใช้ · ทางสำรองเมื่อยิงภาพไม่ได้) — เปิดอ่านหัวข้อนั้นก่อนลงมือทุกครั้ง ที่นี่ถือเฉพาะข้อผูกพันว่าต้องมี
