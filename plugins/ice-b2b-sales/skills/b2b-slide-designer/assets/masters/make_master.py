...
BODY_INK = C["ink"]
MUTED = "6B6B6B"   # V01R03 (2026.09.06): เดิม 8C8C8C ให้ความต่างสีกับพื้นขาวเพียง 3.11 ต่อ 1 ต่ำกว่าเกณฑ์ 4.5
#   ผลตรวจคุณภาพวัดส่วนท้ายหน้าและเลขหน้าได้ 3.12 กับ 4.16 · ค่าใหม่ให้ 4.93 ต่อ 1 ทั้งสองจุด
