...
5. **เก็บและต่อเข้ากับตัวสร้างไฟล์:** ย่อเป็น 2000×1125 บันทึกเป็น .jpg ที่ `<งาน>/_build/assets/bg/` แล้วประกาศที่อยู่ไฟล์ในไฟล์กำหนดเนื้อหาระดับ deck สองช่องคือ `background_dark` และ `background_light` — ตัวสร้างไฟล์ (`_lib/build_pptx.py`) จะวางภาพเต็มหน้าไว้หลังสุดใต้ทุกกล่องข้อความให้เอง ไม่ต้องวางเอง · ไม่ประกาศสองช่องนี้ = ได้พื้นไล่เฉดเปล่าของแม่แบบ ซึ่งถือว่ายังทำไม่ครบตามกติกานี้
