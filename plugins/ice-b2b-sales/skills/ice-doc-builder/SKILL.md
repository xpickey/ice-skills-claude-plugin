...
> **Skill:** ice-doc-builder | **Version:** V01R22 | **Date:** 2026.09.01
...
| **วาดใหม่จากไฟล์ที่ได้รับ** | ลูกค้าหรือทีมส่งไฟล์ `.drawio` หรือ Mermaid `.mmd` มา แล้วต้องการฉบับที่นำเสนอได้ — skill มีตัวสกัดเนื้อหาในตัวและ **วาดใหม่ ไม่ใช่แปลงไฟล์ตรง ๆ** |
