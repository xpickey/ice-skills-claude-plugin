...
> **Skill:** ice-doc-builder | **Version:** V01R18 | **Date:** 2026.08.26
...
## 0.1 เงื่อนไขก่อน build (ข้อ 0-4, 6 และ 8 ต้องครบจึงเริ่ม · ข้อ 5 ทำหลัง build เสร็จ · ข้อ 7 ใช้เมื่อ user เอ่ยชื่อ template)
...
*Skill: ice-doc-builder **V01R17** | 2026.08.08 | สกัดจาก deliverable-gen-agent V02R08 (§4→§1-2·4 · §5→§5 · E4→§0.3+§6) คำต่อคำ + ใหม่: §3 FONT ข้ามฟอร์แมต docx/xlsx/pdf + §0 CONTRACT ICE_BUILD=pipeline + §7 Renderer Ladder + §8 Codex Option*
