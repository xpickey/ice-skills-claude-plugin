<!-- Adapted from frontend-slides (MIT © 2025 Zara Zhang) — https://github.com/zarazhangrui/frontend-slides -->
<!-- See references/NOTICE-html-slides.md. Used for the INLINE execution path (no-shell envs: Cowork/Desktop/Web). -->
