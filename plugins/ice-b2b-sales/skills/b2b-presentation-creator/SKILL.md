...
**บ้านเดียวของรายการตรวจก่อนส่งคือสกิล `ice-doc-builder` หัวข้อ "ลำดับตรวจก่อนส่งผู้ตรวจคุณภาพ"** เปิดอ่านและรันให้ครบทุกข้อก่อนส่งงานให้ผู้ตรวจทุกครั้ง รวมสี่ข้อที่ผู้ตรวจเคยพบซ้ำและเครื่องจับได้ไม่หมด คือ การตัดบรรทัดกลางคำภาษาไทย · ข้อความรอเติมที่หลุดขึ้นหน้างาน · ภาษาที่ต้องอ่านออกเสียงเอง · ความตรงกันระหว่างไฟล์จริงกับ design-spec (ชุด icon สไตล์เดียว · สีตามชุดของหน้า · ภาพตามช่อง visual) · ตารางด้านล่างคือส่วนที่เป็นของสกิลนี้โดยเฉพาะ ไม่ใช่รายการทั้งหมด
